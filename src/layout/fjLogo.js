  ...
  >
    ...
    <g>
      <polygon
        ...
        points="71.2,1 0,118.7 46.2,118.7 78.3,65 68.7,49.9 36.6,101.2 29.6,101.2 70.5,34 120,118.7 169.5,118.7 
		96.8,0 87.5,15.6 137.3,100.9 129.6,100.9 	"
      ></polygon>
      <polygon
        className="st1 svg-elem-3"
        points="93.9,118.7 111.2,118.7 83,72.8 54.6,118.7 71.2,118.7 82,101.3 	"
      ></polygon>
      <path
        className="st1 svg-elem-4"
        d="M126,0h-14.6h-5.6l72.8,119.9h7.6h12.6H298V0H126z M206.5,108.3h-20.9V12.1h66.7v17.2h-46.2v23h43.3v17h-42.8
